#ifndef Ballet_BootUtil_BalSerializeBuffer_H
#define Ballet_BootUtil_BalSerializeBuffer_H
...
namespace Ballet
{
    namespace BootUtil
    {
        struct BalBufferObject_T: public std::string
        {
            typedef BalBufferObject_T tClass;
        ...
        typedef BalBufferObject_T BalPackBuffer;
    }
}
#endif
